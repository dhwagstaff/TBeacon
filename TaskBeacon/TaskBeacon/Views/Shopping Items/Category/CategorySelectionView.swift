...
//                    ForEach(Constants.departmentCategories.keys.sorted(), id: \.self) { department in
//                        DisclosureGroup(department) {
//                            ForEach(Constants.departmentCategories[department]!, id: \.self) { category in
//                                Button(action: {
//                                    if category == "Custom" {
//                                        isCustomCategory = true // ✅ Show text field
//                                    } else {
...
//                    }
//                    
//                    // ✅ Show text field only if "Custom" is selected
//                    if isCustomCategory {
//                        TextField("Enter Custom Category", text: $customCategory)
//                            .textFieldStyle(RoundedBorderTextFieldStyle())
//                            .autocapitalization(.words)
//
//                        Button("Save Custom Category") {
//                            if !customCategory.isEmpty {
//                                selectedCategory = customCategory // ✅ Assign custom value before dismissing
//                                presentationMode.wrappedValue.dismiss()
//                            }
//                        }
//                        .disabled(customCategory.isEmpty)
