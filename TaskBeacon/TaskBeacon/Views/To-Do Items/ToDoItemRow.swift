...
struct ToDoItemRow: View {
    ...
    var body: some View {
        VStack(spacing: 6) { // Added spacing control to main VStack
            ...
            .padding(.top, 8) // Changed from 30 to 8
            
            // Details section
            VStack(alignment: .leading, spacing: 4) { // Changed spacing from 5 to 4
                HStack {
                ...
                .frame(height: 8) // Changed from 10 to 8
                .frame(maxWidth: .infinity, alignment: .leading)
                .padding(.leading, 30)
            }
        ...
        .frame(maxWidth: .infinity, minHeight: 44, maxHeight: 100, alignment: .leading) // Added height constraints
        .background(colorScheme == .dark ? Color(.systemGray6) : Color(.systemBackground))
        .cornerRadius(8)
        .padding(.top, -8) // Changed from -40 to -8
